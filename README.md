...
> **为什么数据不互通？** 由于浏览器的同源策略（Same-Origin Policy），不同域名的网页无法访问彼此的本地存储。这正是你的数据安全的体现！每个域名的笔记完全隔离，不相互污染。
...
- ✅ **源代码开放**：所有 JavaScript 文件开源可审计，**无任何隐藏的网络请求**
...
**版本**: 1.0.0 (Modularized + Privacy-First)  
**许可证**: AGPL-3.0
